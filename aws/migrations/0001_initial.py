# Generated by Django 2.1.5 on 2019-02-05 15:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('app_name', models.CharField(choices=[('asasd', 'asasd'), ('asdasd', 'asdasd'), ('Aifi-2', 'Aifi-2')], max_length=1000)),
                ('env_name', models.CharField(max_length=1000, unique=True)),
                ('stack', models.CharField(choices=[('ami-03787fa0594b1f151 PHP and Lnux', 'ami-03787fa0594b1f151 PHP and Lnux')], max_length=1000)),
