# Generated by Django 2.1.5 on 2019-02-06 05:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('app_name', models.CharField(choices=[('asasd', 'asasd'), ('asdasd', 'asdasd'), ('Aifi-2', 'Aifi-2'), ('ec2-test', 'ec2-test'), ('ec2-second', 'ec2-second')], max_length=1000)),
